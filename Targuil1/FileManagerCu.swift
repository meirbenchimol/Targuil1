...
//  Copyright © 2019 meir Benchimol & Netanel Cohen-Solal. All rights reserved.
//
...
class FileManagerCu{
    ...
    private func translateFileToVM(sourcePath:String, destinationPath:String)->String{
        ...
        translatedAll.append(generateCopyright())
        do{
            //Translate vm file
    ...
    public func generateCopyright()->String{
        var string = [String]();
        string.append("// Generated by Compiler in SWIFT")
        string.append("// Copyright 2019")
        string.append("// Netanel COHEN SOLAL - 1444669")
        string.append("// Meir Benchimol - 1365797")
